...
<div>
    ...
    <h4 style="padding-left: 3%;font-style: italic;font-weight:normal;"><?php _e('The changes you make here will be applicable across user roles. You can exclude Administrator role from these settings.','elex-catmode-rolebased-price');?></h4>
