...
(function(h) {
  ...
  n.defaults = {
    ...
    oLanguage: {
      oAria: {
        sSortAscending: ": "+datatab_tr.trans1,
        sSortDescending: ": "+datatab_tr.trans2
      },
      oPaginate: {
        sFirst: datatab_tr.trans3,
        sLast: datatab_tr.trans4,
        sNext: datatab_tr.trans5,
        sPrevious: datatab_tr.trans6
      },



      sEmptyTable: datatab_tr.trans7,
      sInfo: datatab_tr.trans16+" _START_ "+datatab_tr.trans17+" _END_ "+datatab_tr.trans18+" _TOTAL_ "+datatab_tr.trans19,
      sInfoEmpty: datatab_tr.trans16+" 0 "+datatab_tr.trans17+" 0 "+datatab_tr.trans18+" 0 "+datatab_tr.trans19,
      sInfoFiltered: "( "+datatab_tr.trans14+" _MAX_ "+datatab_tr.trans15+" )",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: datatab_tr.trans8+" _MENU_ "+datatab_tr.trans9,
      sLoadingRecords: datatab_tr.trans12,
      sProcessing: datatab_tr.trans13,
      sSearch: datatab_tr.trans10,
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: datatab_tr.trans11
    },
    oSearch: h.extend({},
      n.models.oSearch),
    sAjaxDataProp: "data",
