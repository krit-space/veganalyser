...
<section class="wrap-detail-page" id="main-content">
	<div class="container">
		...
		<div class="row">
			<div class="<?php echo esc_attr( $feature_image_class ); ?>">
				<?php if( has_post_thumbnail() && !bloguten_get_option( 'disable_single_feature_image' ) ): ?>
				    <div class="post-thumbnail">
				        <?php the_post_thumbnail( 'bloguten-1200-710' ); ?>
				    </div>
				<?php endif; ?>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<?php if( bloguten_get_option( 'single_layout' ) == 'left' ): ?>
				<?php get_sidebar(); ?>
			<?php endif; ?>
			<?php $class = ''; ?>
			<?php
				if( bloguten_get_option( 'single_layout' ) == 'none' ) {
					$class = 'col-lg-12';
				}else {
					$class = 'col-lg-8';
				}
				...
				<main id="main" class="post-main-content" role="main">
					<?php
						...
						while( have_posts() ): the_post();
							...
							if( 'post' == get_post_type() && !bloguten_get_option( 'disable_single_author' ) ) {
							...
							$post_navigation_prev_text = bloguten_get_option( 'single_post_nav_prev' );
							$post_navigation_next_text = bloguten_get_option( 'single_post_nav_next' );
			...
			<?php if( bloguten_get_option( 'single_layout' ) == 'right' ): ?>
				<?php get_sidebar(); ?>
			<?php endif; ?>
		</div>
	</div>
