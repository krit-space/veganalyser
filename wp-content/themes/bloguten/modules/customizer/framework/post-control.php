...
if ( class_exists( 'WP_Customize_Control' ) ) :
    ...
    class Bloguten_Customize_Post_Control extends WP_Customize_Control {
            ...
            if( !empty ( $posts ) ) {
                ...
                <label>
                    ...
                    <select <?php $this->link(); ?>>
                        ...
                        printf( '<option value="0" %s>%s</option>', selected( $this->value(), null, false ), esc_html__( 'Select', 'bloguten' ) );
