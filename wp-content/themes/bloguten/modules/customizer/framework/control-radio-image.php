...
if ( class_exists( 'WP_Customize_Control' ) ) :
    class Bloguten_Customize_Control_Radio_Image extends WP_Customize_Control {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'bloguten-customize-controls', get_template_directory_uri() . '/modules/customizer/framework/js/customize-controls.js', array( 'jquery' ) );
            wp_enqueue_style( 'bloguten-customize-controls', get_template_directory_uri() . '/modules/customizer/framework/css/customize-controls.css' );
        }
