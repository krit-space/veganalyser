...
<footer id="colophon" class="site-footer clearfix">
	...
	<div class="content-wrap">
		...
		<div class="site-info">
			...
			<?php echo __(' | Powered by WordPress and', 'marketingly') ?> <a rel="nofollow" href="<?php echo esc_url('https://superbthemes.com/', 'marketingly'); ?>"><?php echo __('Superb Themes!', 'marketingly') ?></a>
			</span>
